...
<html lang="en-US">
	...
	<title>Log In &lsaquo; Engineeringnepal &#8212; WordPress</title>
...
<link rel="stylesheet" id="buttons-css" href="./wp-includes/css/buttons.min.css?ver=5.9.3" media="all">
<link rel="stylesheet" id="forms-css" href="./wp-admin/css/forms.min.css?ver=5.9.3" media="all">
<link rel="stylesheet" id="l10n-css" href="./wp-admin/css/l10n.min.css?ver=5.9.3" media="all">
<link rel="stylesheet" id="login-css" href="./wp-admin/css/login.min.css?ver=5.9.3" media="all">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Go to Engineeringnepal</a>		</p>
			</div>
...
<script src="./wp-admin/js/password-strength-meter.min.js?ver=5.9.3" id="password-strength-meter-js"></script>
...
<script src="./wp-includes/js/wp-util.min.js?ver=5.9.3" id="wp-util-js"></script>
<script id="user-profile-js-extra">
var userProfileL10n = {"user_id":"0","nonce":"74b717dbd0"};
</script>
...
<script src="./wp-admin/js/user-profile.min.js?ver=5.9.3" id="user-profile-js"></script>
			<script>
